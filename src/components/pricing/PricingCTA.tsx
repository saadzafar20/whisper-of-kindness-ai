    ...
    <section className="py-16 md:py-24 bg-gradient-to-br from-empathy-purple/10 to-empathy-soft-purple/20">
      <div className="container mx-auto px-4 sm:px-6 text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold mb-6 text-gray-800">30-Day Money-Back Guarantee</h2>
          <p className="text-base md:text-lg mb-8 text-gray-700 max-w-2xl mx-auto font-medium">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-4 md:gap-6 mt-10">
            <Button 
              className="bg-empathy-purple hover:bg-empathy-dark-purple text-white px-6 md:px-8 py-3 text-base shadow-md font-medium"
            ...
            <Button 
              variant="outline"
              className="border-2 border-empathy-purple text-empathy-purple hover:bg-empathy-soft-purple/10 px-6 md:px-8 py-3 text-base font-medium"
